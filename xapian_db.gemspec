...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG", "lib/xapian_db.rb", "lib/xapian_db/database.rb", "lib/xapian_db/document_blueprint.rb", "lib/xapian_db/indexer.rb", "lib/xapian_db/adapters/datamapper_adapter.rb"]
